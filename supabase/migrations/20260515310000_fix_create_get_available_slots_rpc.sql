-- Repair: re-create get_available_slots function.
-- Migration 20260515300000 was recorded as applied but the function was never
-- actually executed on the remote DB (invalid timestamp 30:00:00 caused a
-- silent failure during db push). This migration re-creates it idempotently.
