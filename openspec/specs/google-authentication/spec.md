## Purpose
Define baseline Google OAuth authentication behavior via Supabase Auth, including callback completion, frontend session initialization, and required environment configuration.
